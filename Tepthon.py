...
ownerhson_id = 5771711471
@Tepthon.on(events.NewMessage(outgoing=False, pattern='فزعه'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply('هنا يمك زيكو ابشر  @Xx_Sorce')
...
async def _(event):
      await event.reply("""السـورس يعمـل زيكو يعمل بنجاح @Xx_Sorce
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
